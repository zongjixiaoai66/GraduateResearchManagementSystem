...
public class ShangpinChatEntity<T> implements Serializable {
    ...
    @TableField(value = "shangpin_chat_issue")

    private String shangpinChatIssue;
    ...
    @TableField(value = "shangpin_chat_reply")

    private String shangpinChatReply;
	 ...
	 * 获取：问题
	 */
    public String getShangpinChatIssue() {
        return shangpinChatIssue;
    }
    /**
	 * 设置：问题
	 */

    public void setShangpinChatIssue(String shangpinChatIssue) {
        this.shangpinChatIssue = shangpinChatIssue;
    }
    /**
	 * 获取：问题时间
	 */
	 ...
	 * 获取：回复
	 */
    public String getShangpinChatReply() {
        return shangpinChatReply;
    }
    /**
	 * 设置：回复
	 */

    public void setShangpinChatReply(String shangpinChatReply) {
        this.shangpinChatReply = shangpinChatReply;
    }
    /**
	 * 获取：回复时间
	 */
    ...
    public String toString() {
        return "ShangpinChat{" +
            ...
            ", shangpinChatIssue=" + shangpinChatIssue +
            ", issueTime=" + DateUtil.convertString(issueTime,"yyyy-MM-dd") +
            ", shangpinChatReply=" + shangpinChatReply +
